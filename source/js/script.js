...
import AccentTypographyBuild from './modules/animation-text';
...
const animationPrizesTitle = new AccentTypographyBuild('.prizes__title', 700, 'show-text', 'transform', true, 0);
